...
export function PurchasingConsole() {
  ...
  return <div className="dark min-h-screen bg-background text-foreground">
    <aside className="fixed inset-y-0 left-0 z-30 hidden w-64 border-r bg-sidebar p-4 md:flex md:flex-col">
      <div className="flex h-12 items-center gap-3 px-2"><div className="flex size-9 items-center justify-center rounded-lg bg-primary text-sm font-bold text-primary-foreground">R</div><div><p className="font-semibold">Raingentic</p><p className="text-sm text-muted-foreground">PreFlight workspace</p></div></div>
